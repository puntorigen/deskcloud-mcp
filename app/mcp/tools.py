...
Defines all MCP tools for DeskCloud MCP:
- create_session: Create new session with isolated virtual desktop
...
def register_tools(mcp: FastMCP) -> None:
    ...
    async def create_session(
        title: str = "DeskCloud Session",
        model: str | None = None,
        system_prompt_suffix: str = "",
    ) -> dict[str, Any]:
        """
        Create a new session with an isolated virtual desktop.
        ...
        Args:
            title: Human-readable session title (default: "DeskCloud Session")
