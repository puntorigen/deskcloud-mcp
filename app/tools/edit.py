...
- Directory listing uses session-specific environment
"""
...
class EditTool20250124(BaseAnthropicTool):
    ...
    def __init__(self, env: dict[str, str] | None = None):
        """
        Initialize EditTool with optional session-specific environment.
        
        Args:
            env: Session-specific environment dict. Used for directory listing.
        """
