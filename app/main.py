...
A FastAPI server for managing AI desktop sessions with real-time streaming,
persistent storage, and VNC/noVNC integration.
...
### Authentication
Set your Anthropic API key via `ANTHROPIC_API_KEY` environment variable.
        """,
